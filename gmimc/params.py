# params.py
# ---------------------------------------------------------------------------
# Parameter definition for pSquare-hash: the GMiMCParams class.
#
...
class GMiMCParams:
    def __init__(
        ...
        rcons         : R affine round constants; generated via _init_constants if not provided
        ...
        if len(self.rcons) < self.R:
            raise ValueError(f"Expected at least {self.R} round-constant, got {len(self.rcons)}")
