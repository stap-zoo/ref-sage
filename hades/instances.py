...
POSEIDON_GOLDILOCKS_T8 = PoseidonParams(p=GOLDILOCKS.p,        t=8,  alpha=7, R_ext=8, R_int=22, r=4,  c=4, d=4)
POSEIDON_GOLDILOCKS_T12 = PoseidonParams(p=GOLDILOCKS.p,       t=12, alpha=7, R_ext=8, R_int=22, r=8,  c=4, d=4)

# https://extgit.isec.tugraz.at/krypto/zkfriendlyhashzoo/-/blob/master/plain_impls/src/poseidon/poseidon_instance_mersenne.rs
POSEIDON_MERSENNE_T16  = PoseidonParams(p=MERSENNE31.p,        t=16, alpha=5, R_ext=8, R_int=14, r=8,  c=8, d=8)
POSEIDON_MERSENNE_T24  = PoseidonParams(p=MERSENNE31.p,        t=24, alpha=5, R_ext=8, R_int=22, r=16, c=8, d=8)
...
POSEIDON2_GOLDILOCKS_T8 = Poseidon2Params(p=GOLDILOCKS.p, t=8, alpha=7, R_ext=8, R_int=22, r=4, c=4, d=4, mat_diag=[
...
POSEIDON2_GOLDILOCKS_T12 = Poseidon2Params(p=GOLDILOCKS.p, t=12, alpha=7, R_ext=8, R_int=22, r=8, c=4, d=4, mat_diag=[
...
POSEIDON2_GOLDILOCKS_T16 = Poseidon2Params(p=GOLDILOCKS.p, t=16, alpha=7, R_ext=8, R_int=22, r=12, c=4, d=4, mat_diag=[
...
POSEIDON2_GOLDILOCKS_T20 = Poseidon2Params(p=GOLDILOCKS.p, t=20, alpha=7, R_ext=8, R_int=22, r=16, c=4, d=4, mat_diag=[
...
POSEIDON2_MERSENNE_T16 = Poseidon2Params(p=MERSENNE31.p, t=16, alpha=5, R_ext=8, R_int=14, r=8, c=8, d=8, mat_diag=[
...
POSEIDON2_MERSENNE_T24 = Poseidon2Params(p=MERSENNE31.p, t=24, alpha=5, R_ext=8, R_int=22, r=16, c=8, d=8, mat_diag=[
...
NEPTUNE_GOLDILOCKS_T8  = NeptuneParams(p=GOLDILOCKS.p,       t=8,  alpha=7, R_ext=6, R_int=38, r=4, c=4, d=4)
NEPTUNE_GOLDILOCKS_T12 = NeptuneParams(p=GOLDILOCKS.p,       t=12, alpha=7, R_ext=6, R_int=42, r=8, c=4, d=4)
