...
from gmimc.hash import GMiMCPerm, GMiMCHash
...
def test_alpha_must_be_permutation():
    ...
    with pytest.raises(ValueError):
        GMiMCParams(p=GMIMC_BN254_T3.p, t=3, R=5, alpha=2, sponge=dict(r=2, c=1, d=1))


def test_toy_field_warns():
    with pytest.warns(ParamRecommendationWarning):
        GMiMCParams(p=101, t=3, R=5, sponge=dict(r=2, c=1, d=1), toy=True)  # tiny field
...
def test_constants_reproducible():
    ...
    a = GMiMCParams(p=GMIMC_BLS12_T3.p, t=3, R=10, sponge=dict(r=2, c=1, d=1))
    b = GMiMCParams(p=GMIMC_BLS12_T3.p, t=3, R=10, sponge=dict(r=2, c=1, d=1))
